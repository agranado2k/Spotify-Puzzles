...
class ZipfsSongTest < Minitest::Test 

  def test_calculate_zi
    f1 = 30
    song_2_index, z2 = 2, 15
    song_3_index, z3 = 3, 10

    assert_equal z2, ZipfsSong.calculate_zi(f1, song_2_index)
    assert_equal z3, ZipfsSong.calculate_zi(f1, song_3_index)
  end

  def test_calculate_qi_for_first_song
    f1, z1, q1 = 30, 30, 1
    assert_equal q1, ZipfsSong.calculate_qi(f1, z1)
  end

  def test_calculate_qi_for_second_song
    f2, z2, q2 = 30, 15, 2
    assert_equal q2, ZipfsSong.calculate_qi(f2, z2)
  end

  def test_calculate_qi_for_third_song
    f3, z3, q3 = 15, 10, 1.5
    assert_equal q3, ZipfsSong.calculate_qi(f3, z3)
  end

  def test_include_indexies_for_songs_list
    ...
    assert_equal output, ZipfsSong.include_index(song_list)
  end

  def test_include_q_for_each_song
    f1 = 30
    ...
    assert_equal output, ZipfsSong.include_q(f1, song_list)
  end

  def test_select_songs_with_highest_q
    songs_number = 2
    ...
    assert_equal songs_selected, ZipfsSong.select_songs_by_q(songs_number, song_list)
  end
  ...
  def test_sample_1
    ...
    assert_equal output, ZipfsSong.choose_popularities(input)
  end

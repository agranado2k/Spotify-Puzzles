...
require_relative 'cat_vs_dog'

# Cat vs. Dog (Difficulty Level: Hard)
...
class CatVsDogTest < Minitest::Test
  def test_sample_1
    ...
    viewers = 1
    cat_vs_dog = CatVsDog.new(cats, dogs, voters)
    assert_equal viewers, cat_vs_dog.maximize_viewers(votes) 
  end
